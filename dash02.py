...
if filtered.empty:
    ...
    fig_original = go.Figure([
        ...
        go.Bar(name="Тенденция ОП", x=agg["Вид плана продаж"], y=agg["Тенденция по кол-ву рабочих дней"],marker_color='#2ca820'),
        go.Bar(name="Факт Валовая прибыль", x=agg["Вид плана продаж"], y=agg["Факт Валовая прибыль"],marker_color='#1f77b4'),
        go.Bar(name="Тенденция ВП", x=agg["Вид плана продаж"], y=agg["ТВП Тенденция по кол-ву рабочих дней"],marker_color='#1f77a4')
    ])
